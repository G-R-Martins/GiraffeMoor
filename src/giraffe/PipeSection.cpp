...
PipeSection::PipeSection()
	: m_number(0), m_is_beam(false), m_diameter(0.0), m_rho(0.0), 
	m_EA(0.0), m_EI(0.0), m_GJ(0.0), m_GA(0.0), 
	m_CDt(0.0), m_CDn(0.0), m_CAt(0.0), m_CAn(0.0), 
	m_E(0.0), m_nu(0.0)
{}

PipeSection::PipeSection(size_t number, bool is_beam, double d, double rho,
	double EA, double EI, double GJ, double GA,
	double CDt, double CDn, double CAt, double CAn,
	double E, double nu)
	: m_number(number), m_is_beam(is_beam), m_diameter(d), m_rho(rho),
...
PipeSection::PipeSection(const SegmentProperty& moor_prop)
	: m_number(moor_prop.GetNumber()), m_is_beam(moor_prop.IsBeam()), 
