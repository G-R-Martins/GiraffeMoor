...
bool VesselDisplacement::CheckIfIsTable() const
{
	return this->isTable;
}

bool VesselDisplacement::CheckIfIsMathCode() const
{
	return this->isMathCode;
}

bool VesselDisplacement::CheckIfIsSineWave() const
{
	return this->isSineWave;
}

bool VesselDisplacement::CheckIfIsExternalFile() const
{
