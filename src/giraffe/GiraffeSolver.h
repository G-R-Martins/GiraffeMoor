...
struct ConvergenceCriteria
{
	...
	friend std::ostream& operator<<(std::ostream& fout, const ConvergenceCriteria& conv_criteria);
};
...
protected:
	ConvergenceCriteria m_conv_criteria;
...
public:
	...
	inline const bool RunGiraffe() const { return m_run_Giraffe; }
